...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |Ctrl|Win |Alt |        Space          |Mo3|Alt|Ctrl|Lef|Dow|Righ|
   * `----------------------------------------------------------------'
   */
[0] = LAYOUT_65_ansi(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,                KC_SPC,                          MO(3),   KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
...
[3] = LAYOUT_65_ansi(
  ...
  KC_LCTL,XXXXXXX,XXXXXXX,                XXXXXXX,                        XXXXXXX,  KC_APP,KC_RCTL,_______,_______,_______)
};
